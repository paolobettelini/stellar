...
def crop_and_redact_pdf(input_pdf, output_pdf, y1, y2, right_margin, left_margin):
...
if __name__ == '__main__':
    ...
    crop_and_redact_pdf(args.input_pdf, args.output_pdf, args.y1, args.y2, args.right_margin, args.left_margin)