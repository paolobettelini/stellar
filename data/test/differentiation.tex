...
\subsubsection{Subtangent} %subtangent
...
\subsection{Rate of Growth} % rate-of-growth
...
\subsection{First Derivative Test} % first-derivative-test
...
\subsection{Concavity} % concavity
...
\subsection{Second Derivative Test} % second-derivative-test
...
\section{Absolute Extrema} % absolute-extrema
...
\section{Rules for differentiation} % rules-for-differentiation
...
\section{L'Hôpital Rule} % hopital-rule
...
\section{Intermediate value Theorem} % intermediate-value-theorem

A function \(f\) continuous on an interval \([a;b]\) will take
every value in the interval \([f(a);f(b)]\).

\section{Bolzano's Theorem} % bolzano-theorem
...
\section{Weierstrass Theorem} % weierstrass-theorem

If \(f(x)\) is continuous in \([a;b]\) then the function will have a maxima and a minima.

\section{Rolle's Theorem} % rolle-theorem
...
\section{Mean Value Theorem} % mean-value-theorem
...
\section{Differentials} % differentials
